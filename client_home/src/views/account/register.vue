						...
						<div class="card">
							...
							<div class="form_register">
								<b-form>
									...
									<!--社区用户-->
									<form_community_users v-if="form.user_group === '社区用户'" :form="form_sub"></form_community_users>
...
<script>
	...
	/* 社区用户 */
	import form_community_users from "@/components/diy/form_community_users";

	export default {
		components: {
			/* 社区用户 */
			form_community_users,
		},
