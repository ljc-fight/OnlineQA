...
const routes = [
	...
	// 社区用户路由
	{
		path: '/community_users/table',
		name: 'community_users_table',
		component: () => import('../views/community_users/table.vue')
	},
	{
		path: '/community_users/view',
		name: 'community_users_view',
		component: () => import('../views/community_users/view.vue')
	},
